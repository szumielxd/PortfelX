...
public class EcoSetCommand<C> extends SimpleCommand<C> {
	...
	@Getter private final @NotNull LangKey description = ProxyLangKey.COMMAND_USER_ECO_SET_DESCRIPTION;
	

	public EcoSetCommand(@NotNull Portfel<C> plugin, @NotNull ParentLikeCommand<C> parent) {

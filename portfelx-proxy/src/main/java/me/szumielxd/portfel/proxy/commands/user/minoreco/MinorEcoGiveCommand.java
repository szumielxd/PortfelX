...
public class MinorEcoGiveCommand extends SimpleCommand {
	
	
	private final List<CmdArg> args = Arrays.asList(CommonArgs.ECO_AMOUNT);
	

	public MinorEcoGiveCommand(@NotNull Portfel plugin, @NotNull AbstractCommand parent) {
	...
	public void onCommand(@NotNull CommonSender sender, @NotNull Object[] parsedArgs, @NotNull String[] label, @NotNull String[] args) {
		...
		if (parsed != null) {
			...
			sender.sendTranslated(Portfel.PREFIX.append(LangKey.COMMAND_USER_MINORECO_GIVE_SUCCESS.component(LIGHT_PURPLE,
	...
	public @NotNull LangKey getDescription() {
		return LangKey.COMMAND_USER_MINORECO_GIVE_DESCRIPTION;
	}

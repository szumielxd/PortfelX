...
public class HelpCommand extends SimpleCommand {
	...
	public HelpCommand(@NotNull PortfelProxyImpl plugin, @NotNull MainCommand parent, @NotNull String name, @NotNull String... aliases) {
	...
	public void onCommand(@NotNull CommonSender sender, @NotNull Object[] parsedArgs, @NotNull String[] label, @NotNull String[] args) {
		...
		String pluginVersion = pl.getName() + " " + pl.getVersion();
		...
		runningHover = runningHover.append(Component.newline()).append(LangKey.MAIN_VALUENAME_DESCRIPTION.component(AQUA))
				...
				.append(Component.text(pl.getDescriptionText(), GRAY));
		//enabled

...
public class MinorEcoTakeCommand extends SimpleCommand {
	...
	public void onCommand(@NotNull CommonSender sender, @NotNull Object[] parsedArgs, @NotNull String[] label, @NotNull String[] args) {
		...
		if (parsed != null) {
			...
			if (user.getBalance() < amount) {
				sender.sendTranslated(Portfel.PREFIX.append(LangKey.COMMAND_USER_MINORECO_TAKE_SMALLER.component(RED)));
				return;
			}
			user.takeMinorBalance(amount);
			sender.sendTranslated(Portfel.PREFIX.append(LangKey.COMMAND_USER_MINORECO_TAKE_SUCCESS.component(LIGHT_PURPLE,
	...
	public @NotNull LangKey getDescription() {
		return LangKey.COMMAND_USER_MINORECO_TAKE_DESCRIPTION;
	}

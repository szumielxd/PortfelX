...
public class SetupChannelListener<T extends PortfelProxyImpl<C>, C> extends SpecificChannelListener<T, C> {
	...
	// Setup
	// Register
	private Optional<Boolean> onRegistrationCallback(@NotNull ProxyPlayer<C> target, @NotNull String tag, @NotNull String subchannel, @NotNull ByteArrayDataInput in) {

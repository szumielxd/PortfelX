...
import me.szumielxd.portfel.bungee.database.token.AbstractTokenDB.DateCondition;
...
public class CreategiftcodeCommand extends SimpleCommand {
	...
	public CreategiftcodeCommand(@NotNull PortfelBungeeImpl plugin, @NotNull AbstractCommand parent) {
	...
	public void onCommand(@NotNull CommonSender sender, @NotNull Object[] parsedArgs, @NotNull String[] label, @NotNull String[] args) {
		...
		try {
			...
			pl.getTokenDB().registerToken(token, servers, order, BungeeActionExecutor.sender(sender), expiration);

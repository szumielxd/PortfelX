...
public class ListgiftcodesCommand extends SimpleCommand {
	...
	public void onCommand(@NotNull CommonSender sender, @NotNull Object[] parsedArgs, @NotNull String[] label, @NotNull String[] args) {
		...
		if (parsed != null) {
			try {
				List<PrizeToken> tokens = ((PortfelBungeeImpl)this.getPlugin()).getTokenDB().getTokens((String[])parsed[2], (String[])parsed[3], (String[])parsed[4], (DateCondition[])parsed[5], (DateCondition[])parsed[6]);

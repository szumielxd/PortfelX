...
public class HelpCommand extends SimpleCommand {
	...
	public void onCommand(@NotNull CommonSender sender, @NotNull Object[] parsedArgs, @NotNull String[] label, @NotNull String[] args) {
		...
		String pluginVersion = this.plugin.getDescription().getName() + " " + this.plugin.getDescription().getVersion();
		...
		runningHover = runningHover.append(Component.newline()).append(LangKey.MAIN_VALUENAME_DESCRIPTION.component(AQUA))
				...
				.append(Component.text(this.plugin.getDescription().getDescription(), GRAY));
		//enabled
		...
		runningHover = runningHover.append(Component.newline()).append(LangKey.MAIN_VALUENAME_AUTHORS.component(AQUA))
				.append(Component.space())
				.append(Component.text(this.plugin.getDescription().getAuthor(), GRAY));

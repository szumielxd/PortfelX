...
public class KyoriUtils {
	...
	public static final @Nullable Class<?> COMPONENT_CLAZZ = ReflectionUtils.tryGetClass(ADVENTURE_PATH + ".text.ComponentLike");
	public static final @Nullable Class<?> COMPONENTLIKE_CLAZZ = ReflectionUtils.tryGetClass(ADVENTURE_PATH + ".text.ComponentLike");
	private static final @Nullable Class<?> GSONSERIALIZER_CLAZZ = ReflectionUtils.tryGetClass(ADVENTURE_PATH + ".text.serializer.gson.GsonComponentSerializer");
	...
	public static @NotNull Object toCommonKyori(@NotNull Component component) {
		if (GSONSERIALIZER_CLAZZ == null) {
			throw new IllegalStateException("cannot find native adventure-api");
		}
	...
	public static @NotNull Component fromCommonKyori(@NotNull Object component) {
		...
		if (!COMPONENT_CLAZZ.isInstance(component)) {
			throw new IllegalArgumentException(String.format("component must be instance of `%s`", COMPONENT_CLAZZ.getName()));
		}
		try {

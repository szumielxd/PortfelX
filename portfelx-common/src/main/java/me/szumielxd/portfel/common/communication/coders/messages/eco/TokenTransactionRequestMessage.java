...
@IdentifiedMessage(SubchannelName.TOKEN)
@AllArgsConstructor
@NoArgsConstructor
@ToString
@EqualsAndHashCode
public class TokenTransactionRequestMessage implements MessagePacket {
	...
	public static class CryptoPayload {
		...
		@Getter @MessageEntry(MessageEntryCoders.UTF) private @NotNull String token;
		@Getter @MessageEntry(MessageEntryCoders.UTF) private @NotNull String order;
		@Getter @MessageEntry(MessageEntryCoders.INTEGER) private int globalOrders;

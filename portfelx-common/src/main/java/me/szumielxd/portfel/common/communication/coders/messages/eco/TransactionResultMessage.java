...
@ToString
@EqualsAndHashCode
public class TransactionResultMessage implements MessagePacket {
	...
	public static class CryptoPayload {
		...
		@Getter @MessageEntry(MessageEntryCoders.UUID) private @NotNull UUID transactionId;
		...
		@Getter @MessageEntry(MessageEntryCoders.INTEGER) private @NotNull int globalOrders;

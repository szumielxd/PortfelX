...
public class PortfelTopEnabledCalculator<T, C> implements ContextCalculator<T> {
	...
	public PortfelTopEnabledCalculator(@NotNull Portfel<C> plugin, @NotNull String key, Class<? extends T> playerClass) {
		this.plugin = plugin;
		this.key = key;
		try {

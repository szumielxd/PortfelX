...
@IdentifiedMessage(SubchannelName.REGISTER)
@AllArgsConstructor
@NoArgsConstructor
@ToString
@EqualsAndHashCode
public class RegistrationResultMessage implements MessagePacket {
	...
	public static class CryptoPayload {
		...
		@Getter @MessageEntry(MessageEntryCoders.ENUM) private @NotNull RegistrationStatus status;
